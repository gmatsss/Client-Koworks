      ...
      <div className="container k-container">
        <div className="row align-items-center e-steps mtop-45 mbot-40">
          ...
          <div className="col e-step-content">
            ...
            <p>
              Create an employer account before you can advertise your vacancy
              on Linkage. Navigate to the register page and provide your company
              name and email address. The account verification process will
              begin once you click “Continue.”
            </p>
            <a href="/" className="btn-default-red text-center">
              Continue
            </a>
          </div>
        </div>
        <div className="row align-items-center e-steps mtop-45 mbot-40 ptb-40">
          <div className="col e-step-content">
            ...
            <p>
              Make your next great hire with Linkage. Check our pricing and see
        ...
        <div className="row align-items-center e-steps mtop-45 mbot-40 ptb-40">
          ...
          <div className="col e-step-content">
            ...
            <p>
              ...
              <br />
              Proactively look for people who have the skills, abilities, and
              experience you require ahead of time.
            </p>
            <p>
              <span className="red f-18">Post a Job</span>
              <br />
              Let talented individuals come to you and apply for positions.
            </p>
          </div>
        </div>
        <div className="row align-items-center e-steps mtop-45 mbot-40 ptb-40">
          <div className="col e-step-content">
            ...
            <ul>
              ...
              <li>
                Interview candidates like you would for a regular employee.
              </li>
        ...
        <div className="row align-items-center e-steps mtop-45 mbot-40 ptb-40">
          ...
          <div className="col e-step-content">
            ...
            <ul>
              <li>
                Make a job offer and negotiate pay, working hours,andexpection.
              </li>
              <li>
                Manage work hours of employees through our exclusive platforms
                and pay them online.
              </li>
              <li>No taxes to pay.</li>
              <li>
                Get good at hiring and managing your Filipino virtual staff.
              </li>
            </ul>
            <a href="/" className="btn-default-red text-center">
              Get Started
